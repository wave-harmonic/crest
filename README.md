...
* Support transparency/translucency/refraction - render out per-pixel depth of ocean surface in a first pass, then render frontmost ocean surface in second pass.
