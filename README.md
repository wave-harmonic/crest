...
* To simulate and render foam, create a new GameObject and add the *Create Sims* component. By default foam sims at a few different resolutions will be created, but this can be configured as desired.
