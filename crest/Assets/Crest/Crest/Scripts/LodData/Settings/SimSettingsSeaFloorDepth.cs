...
namespace Crest
{
    ...
    {
        [Tooltip("Allow multiple sea levels. This allows multiple bodies of water at different altitudes from the global sea level. The global sea level is set by the Y position of the Ocean GameObject.")]
