...
//        //    var h0 = SampleHeightBurst(ref lerpData, f0, parameters, in framesFlattened);
//        //    var h1 = SampleHeightBurst(ref lerpData, f1, parameters, in framesFlattened);
        
//        //    return math.lerp(h0, h1, alphaT);
//        //}

//        [MethodImpl(MethodImplOptions.AggressiveInlining)]
//        static float4 SampleHeightBurst(ref SpatialInterpolationData lerpData, int4 frameIndex, FFTBakedDataParametersMultiRes parameters, in NativeArray<half> framesFlattened)
//        {
//            // lookup 4 values
//            var textureResolution = parameters._textureResolution;
//            var indexBase = frameIndex * textureResolution * textureResolution * parameters._lodCount;
