...
#pragma warning restore 414
        ...
        public bool Paint(Vector3 paintPosition3, Vector2 paintDir, float paintWeight, bool remove)
        {
            ...
            return _paintData.PaintSmoothstep(this, paintPosition3, 0.0125f * paintWeight, paintDir, PaintableEditorBase.s_paintRadius, PaintableEditorBase.s_paintStrength, CPUTexturePaintHelpers.PaintFnAdditivePlusRemoveBlendSaturateVector2, remove);
        }
        #endregion
