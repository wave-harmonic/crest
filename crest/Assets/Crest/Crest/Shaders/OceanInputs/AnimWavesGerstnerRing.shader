...
// Works with 'ring' mesh to add gersnter waves directed towards center of object

Shader "Crest/Inputs/Animated Waves/Gerstner Ring"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            v2f vert (appdata v)
            {
				...
				float3 positionOS = normalize(v.vertex.xyz);
				o.axisX = float2(-positionOS.x, positionOS.y);
				...
				const float2 wavePosition = v.uv * float2(aveCircum, _RadiusOuter - _RadiusInner);
