	...
	SubShader
	{
		...
		Pass
		{
			...
			Varyings Vert(Attributes input)
			{
				...
				half foam = 0.0;
				half sss = 0.;
				SampleDisplacements(_LD_Sampler_AnimatedWaves_0, LD_0_WorldToUV(wxz), wt_0, worldPos, sss);
				SampleDisplacements(_LD_Sampler_AnimatedWaves_1, LD_1_WorldToUV(wxz), wt_1, worldPos, sss);
