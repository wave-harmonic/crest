...
//				}
			...
			fixed4 Frag( Varyings input ) : SV_Target
			{
				...
				if( isUnderwater )
				{
					...
					// TODO - something like this to compensate for air segment of ray
					//sceneZ -= dot(input.viewWS, _CamForward);
					sceneColour = ApplyUnderwaterEffect(sceneColour, sceneZ01, sceneZ, view, isOceanSurface);
				}
