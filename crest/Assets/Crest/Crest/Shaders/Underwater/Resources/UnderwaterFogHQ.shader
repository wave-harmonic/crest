...
Shader "Hidden/Crest/Underwater/Apply Underwater Fog HQ"
{
	SubShader
	{
		...
		GrabPass
		{
			// We want a new one everything... :O
		}
		...
		Pass
		{
			...
			fixed4 Frag (Varyings input) : SV_Target
			{
				...
				half3 sceneColour = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_GrabTexture, uvScreenSpace).rgb;
				...
				// Issue: using the alpha breaks fog as fog needs to be applied 100% at some point.
