...
namespace Crest
{
    ...
    /// </summary>
    public class LodDataDynamicWavesNew : LodDataPersistent
    {
        public override SimType LodDataType { get { return SimType.DynamicWavesNew; } }
        protected override string ShaderSim { get { return "Ocean/Shape/Sim/2D Wave Equation New"; } }
        public override RenderTextureFormat TextureFormat { get { return RenderTextureFormat.RGHalf; } }
        public override int Depth { get { return -40; } }
        protected override Camera[] SimCameras { get { return OceanRenderer.Instance.Builder._camsDynWavesNew; } }
