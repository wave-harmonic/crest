...
namespace Crest
{
    ...
    public class OceanRenderer : MonoBehaviour
    {
        ...
        [Tooltip("Dynamic waves generated from interactions with objects such as boats generated by a shallow water simulation."), SerializeField]
        bool _createDynamicWaveSimSWE = false;
        public bool CreateDynamicWaveSimSWE { get { return _createDynamicWaveSimSWE; } }
        public SimSettingsWave _simSettingsDynamicWavesSWE;
        ...
        [HideInInspector] public LodDataMgrDynWavesSWE _lodDataDynWavesSWE;
        ...
        void LateUpdateLods()
        {
            ...
            if (_lodDataDynWavesSWE) _lodDataDynWavesSWE.UpdateLodData();
        ...
        public void CountDynamicWaveSims(int countFrom, out int o_present, out int o_active)
        {
            o_present = 0;
            o_active = 0;
            if (_lodDataDynWaves == null && _lodDataDynWavesSWE == null) return;

            o_present = CurrentLodCount;
            for (int i = 0; i < o_present; i++)
            {
                if (i < countFrom) continue;
                if (_lodDataDynWaves != null && !_lodDataDynWaves.SimActive(i)) continue;
                if (_lodDataDynWavesSWE != null && !_lodDataDynWavesSWE.SimActive(i)) continue;
