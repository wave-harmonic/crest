			...
			Pass
			{
				...
				v2f vert( appdata_t v )
				{
					...
					if (wt_0 > 0.001)
					{
						...
						#if _SHADOWS_ON
						SampleShadow(_LD_Sampler_Shadow_0, uv_0, wt_0, o.n_shadow.w);
						#endif
					}
					if (wt_1 > 0.001)
					{
						...
						#if _SHADOWS_ON
						SampleShadow(_LD_Sampler_Shadow_1, uv_1, wt_1, o.n_shadow.w);
						#endif
					}
				...
				half4 frag(v2f i) : SV_Target
				{
					...
					half3 col = OceanEmission(i.worldPos, i.lodAlpha_worldXZUndisplaced_oceanDepth.w, view, n_pixel, n_geom, lightDir, shadow, i.grabPos, screenPos, pixelZ, uvDepth, sceneZ, sceneZ01, bubbleCol, _Normals, _CameraDepthTexture);

					ApplyReflection(view, n_pixel, lightDir, shadow, i.foam_screenPos.yzzw, col);
