	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag (v2f i) : SV_Target
			{
				...
				float2 worldPos = LD_uvToWorld(i.uv, _LD_Pos_Scale_0.xy, _LD_Params_0.y, _LD_Params_0.x);

				// sample the shape 1 texture at this world pos
				float2 uv_1 = LD_worldToUV(worldPos, _LD_Pos_Scale_1.xy, _LD_Params_1.y, _LD_Params_1.x);
